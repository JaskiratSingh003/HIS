...
class Patient(Person):
    ...
    # UPDATE: Added in a dictionary for the patients to store information once a doctor/nurse types in info.
    patient_records = {}
    ...
    def __init__(self, first_name, last_name, department, patient_id, age, address, admit_date):
        ...
        # UPDATE: Add patient object to the dictionary and have the patient ID be represented as the key.
    ...
    # UPDATE: The method add_lab_test() takes in the test name and cost in the Doctor's module to order tests and update the patient's profile.
